 ...
 * UPDATED: Bulletproof Save-On-Close implementation.
 */
public class SavingsTrackerNiAres extends JFrame {
    ...
    public SavingsTrackerNiAres() {
        ...
        // --- THE BULLETPROOF SAVE MECHANISM ---
        // Force the app to wait and execute our save logic before closing
        setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
        addWindowListener(new java.awt.event.WindowAdapter() {
            @Override
            public void windowClosing(java.awt.event.WindowEvent windowEvent) {
                // 1. Explicitly save all data to the .dat file
                SavingsTrackerSystem.getInstance().saveData();
                // 2. Safely terminate the Java application
                System.exit(0);
            }
        });
        // --- END SAVE MECHANISM ---
